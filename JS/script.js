...
function createNav() {
    ...
    const navItems = ['About', 'Features', 'Pricing', 'Testimonials'];
...
function createAbout() {
    ...
    aboutText.innerHTML = "<p><span>MkgLandingPage</span> is the ultimate app for your weekend getaways, business and holiday trips.</br></br>Pay less for more by comparing holiday providers as well as host reviews across sites!</p>"
